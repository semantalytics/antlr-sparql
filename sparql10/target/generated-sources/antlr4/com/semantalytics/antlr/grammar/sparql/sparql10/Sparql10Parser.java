...
public class Sparql10Parser extends Parser {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"builtInCall", "regexExpression", "iriRefOrFunction", "rdfLiteral", "numericLiteral", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"TRUE", "SAMETERM", "FALSE", "AS", "ISBLANK", "COMMENT", "ASTERISK", 
			"DOT", "OPEN_CURLY_BRACE", "CLOSE_CURLY_BRACE", "SEMICOLON", "COMMA", 
			"OPEN_BRACE", "CLOSE_BRACE", "OPEN_SQUARE_BRACE", "CLOSE_SQUARE_BRACE", 
			"LESS_EQUAL", "GREATER_EQUAL", "NOT_EQUAL", "NOT_SIGN", "DIVIDE", "EQUAL", 
			"LESS", "GREATER", "PLUS", "MINUS", "AND", "OR", "REFERENCE", "IRI_REF", 
